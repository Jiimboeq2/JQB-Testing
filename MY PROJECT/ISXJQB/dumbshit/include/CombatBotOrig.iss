		...
		;echo ${Script.RunningTime}
			...
			;{
				...
				if ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}>0
				{
					...
					call CheckAbilitiesObj.CheckAllOLD ${mainCount} ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].Items}
...
objectdef CheckAbilitiesObject
{
	...
	member:bool SetCastTarget(int _count)
	{
		;echo SetCastTarget(int _count=${_count})
		if ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].NotEqual[FALSE]}
		{
			if ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].NotEqual[@Group]} && ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].NotEqual[@Raid]} && ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].NotEqual[@Me]} && ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].NotEqual[@NotSelfGroup]} && ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].NotEqual[@PCTarget]}
			{
				;echo ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]} ability has target
				CastTarget:Set[${This.ConvertAliases[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|]}]}]
				if ${CastTarget}==0
				{
					if ${CombatBotDebug}
						echo Skipping Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, we didnt find target ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|]}
					return FALSE
				}
				else
				{	
					...
					elseif ${Me.Raid}>0 && ${istrExportAllowRaid.Get[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[2,|]}].Equal[TRUE]}
					{
						...
						if ${Actor[id,${CastTarget}](exists)} && ${Me.Raid[id,${CastTarget}].InZone}
						{
							...
							if ${Me.Raid[id,${CastTarget}].Distance}>${istrExportMaxRange.Get[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[2,|]}]}
							{
								if ${CombatBotDebug}
									echo Skipping Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, ${CastTarget} is not within range
								boolAbilityCast:Set[FALSE]
								boolItemCast:Set[FALSE]
								return FALSE
							}
						...
						{
							if ${CombatBotDebug}
								echo Skipping Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, we didnt find target ${Actor[${CastTarget}].Name}
							boolAbilityCast:Set[FALSE]
							boolItemCast:Set[FALSE]
							return FALSE
						}
					...
					else
					{
						...
						{
							if ${CombatBotDebug}
								echo Skipping Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, we didnt find target ${Actor[${CastTarget}].Name} in our group and the ability does not allow raid
							boolAbilityCast:Set[FALSE]
							boolItemCast:Set[FALSE]
							return FALSE
						}
			...
			elseif ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].Equal[@Me]}
				CastTarget:Set[${Me.ID}]
			elseif ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].Equal[@PCTarget]}
			{
				...
				{
					if ${CombatBotDebug}
						echo Ignoring PCTarget Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, neither our target nor implied target are a player character
					return FALSE
				}
			}
			elseif ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].Equal[@Group]}
			{
				if ${Me.Group}>1
				...
				{
					if ${CombatBotDebug}
						echo Ignoring Group Target Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, we are not in a group
					return FALSE
				}
			}
			elseif ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].Equal[@Raid]}
			{
				if ${Me.Raid}>0
				{
					if ${istrExportAllowRaid.Get[${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[2,|]}].Equal[TRUE]}
						CastTarget:Set[@Raid]
					else
					{
						if ${CombatBotDebug}
							echo Ignoring Raid Target Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, does not allow raid
						return FALSE
					}
				}
				else
				{
					if ${CombatBotDebug}
						echo Ignoring Raid Target Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, we are not in a raid
					return FALSE
				}
			}
			elseif ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[4,|].Equal[@NotSelfGroup]}
			{
				if ${Me.Raid}>0
				...
				{
					if ${CombatBotDebug}
						echo Ignoring NotSelfGroup Target Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, there are no other groups
					return FALSE
				}
			}
			else
			{
				if ${CombatBotDebug}
					echo CombatBot error: I did not understand the target for ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}]}
;						- FULLVALUE - ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value}
			}
			if ( ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[3,|].Equal[Heal]} || ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[3,|].Equal[Power]} || ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[3,|].Equal[InCombatTargeted]} || ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[3,|].Equal[Cure]} || ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[3,|].Equal[Buff]} || ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[3,|].Equal[OutOfCombatBuff]} )
			{
				;echo ability is death check cast target ability
				if ${Actor[id,${CastTarget}].IsDead}
				{
					if ${CombatBotDebug}
						echo Ignoring Ability: ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]}, ${Actor[id,${CastTarget}].Name} is dead
					return FALSE
				}
		...
		else
		{
			...
			;echo ${UIElement[CastStackAbiltiesListBox@CastStackFrame@CombatBotUI].OrderedItem[${_count}].Value.Token[1,|]} ability has no target
		}
		;echo ${CastTarget}
		return TRUE
	}
	...
	function CheckAllOLD(int start, int end)
	{
		;echo ${Script.RunningTime}
